# Generated by Django 3.2 on 2022-12-22 07:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lstPrdtNm', models.CharField(blank=True, max_length=200, verbose_name='습득물 이름')),
                ('lstFilePathImg', models.ImageField(blank=True, upload_to='public/images', verbose_name='사진 등록')),
                ('lstcontent', models.CharField(default='', max_length=500, verbose_name='특이사항')),
                ('lstYmd', models.DateField(blank=True, max_length=10)),
